...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-center">
      <section className="px-4 w-full bg-[url('/images/pattern.svg'), #3a889e] min-h-[32rem] h-full pt-8 lg:pt-12 flex flex-col lg:flex-row items-center justify-evenly py-4">
