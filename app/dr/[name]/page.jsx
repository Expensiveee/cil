  ...
  return (
    <div className="flex flex-col w-full h-auto">
      ...
      <section className="flex flex-col lg:flex-row w-full h-auto">
        <div className="flex flex-col items-left text-left justify-start w-full lg:w-2/5 bg-cil-100 gap-4 p-4 py-6 lg:p-16">
          <h2 className="text-white w-fit border-b-4 border-b-cil-100 text-4xl lg:text-5xl mx-auto lg:mx-0 font-semibold mb-12">
            Expérience
          </h2>
          <ul className="flex flex-col gap-6">
        ...
        <div className="flex flex-col items-left text-center lg:text-left justify-start w-full lg:w-3/5 h-auto gap-4 p-4 py-6 lg:p-16">
          <div className="flex flex-col w-full h-auto gap-2">
            <h1 className="text-blue-950 text-4xl lg:text-5xl mx-auto lg:mx-0 font-semibold">
              {user?.name}
            </h1>
