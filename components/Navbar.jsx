...
export default () => {
  ...
  return (
    <nav className="z-50 fixed top-0 w-full md:max-w-[1600px] h-12 md:h-16 md:flex md:items-center border-b-0 md:border-b-2 md:border-b-cil-100  md:justify-between bg-white/40 shadow-md backdrop-blur-xl md:px-4">
