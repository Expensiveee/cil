  ...
  return (
    <nav className="z-50 sticky top-0 w-full lg:max-w-[2400px] h-12 lg:h-16 lg:flex lg:items-center border-b-0 lg:border-b-2 lg:border-b-cil-100  lg:justify-between bg-white/40 shadow-md backdrop-blur-xl">
      ...
      >
        ...
        >
          <p className="text-sm h-full text-left w-full flex items-center justify-between lg:justify-start gap-3">
            Notre Équipe
            <ChevronDownIcon
          ...
          >
            ...
            >
              <li className="flex w-full items-center text-left h-full hover:bg-black/10 px-4 py-1.5 transition-colors text-gray-800 duration-400 ease-in-out rounded-lg">
